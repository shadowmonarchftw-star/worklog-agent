...
export function saveHistoryEntry(db, entry) {
  db.prepare(
    `INSERT INTO history
      (id, developer_name, work_date, style, repos, activity, summary, commit_count, pull_request_count, activity_source, created_at)
     VALUES
      (@id, @developerName, @workDate, @style, @repos, @activity, @summary, @commitCount, @pullRequestCount, @activitySource, @createdAt)
